...
#download computer setup startup script
Download-To "https://raw.githubusercontent.com/IhorBand/cloud-gaming-vm/main/step3/preparecomputer.ps1" "C:\preparecomputer.ps1"
$destinationFilePath = [System.IO.Path]::Combine($startupPath, 'start_preparecomputer.bat')
Download-To "https://raw.githubusercontent.com/IhorBand/cloud-gaming-vm/main/step3/start_preparecomputer.bat" $destinationFilePath


#remove old script
# Build the full destination path including the filename
$installgpudriverFilePath = [System.IO.Path]::Combine($startupPath, 'start_installgriddriver.bat')
