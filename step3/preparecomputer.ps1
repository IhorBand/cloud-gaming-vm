...
Download-To "https://raw.githubusercontent.com/IhorBand/cloud-gaming-vm/main/step4/setupparsec.ps1" "C:\setupparsec.ps1"
$destinationFilePath = [System.IO.Path]::Combine($startupPath, 'start_setupparsec.bat')
Download-To "https://raw.githubusercontent.com/IhorBand/cloud-gaming-vm/main/step4/start_setupparsec.bat" $destinationFilePath
