...
$destinationFilePath = [System.IO.Path]::Combine($destinationFolderPath, 'prepareuranus.ps1')
Download-To "https://raw.githubusercontent.com/IhorBand/cloud-gaming-vm/main/prepareuranus.ps1" $destinationFilePath
